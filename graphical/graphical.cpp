...
bool Graphical::attend_data(std::string label, Attend_Data* attend_data, std::string first_lesson_name, std::string second_lesson_name)
{
    ...
    std::string first_lesson_name_item = (first_lesson_name + "##1");
    std::string second_lesson_name_item = (second_lesson_name + "##2");
    const char* items[] = {lesson_concat.c_str(), first_lesson_name_item.c_str(), second_lesson_name_item.c_str()};
