...
static int popup_add_working_out_select_lesson = -1;
...
bool popup_add_working_out(std::vector<Student>* all_students, std::vector<Group>* all_groups, std::vector<Calendar_Day>* all_days, std::vector<std::vector<Lesson_Info>>* all_lessons, int* selected_to_add, int first_mwday, int number_of_days);
