...
public:
    ...
    bool set_status(int known_id_merged_lesson, int internal_lesson, int known_id_student, int status);
    Student_Status get_status(Lesson_Info& merged_lesson, int internal_lesson, Student& student) const;
    Student_Status get_status(int known_id_merged_lesson, int internal_lesson, int known_id_student);
    ...
    bool add_workout(int known_id_student, int known_id_merged_from, int internal_from, Lesson_Info& merged_to, int internal_to);
