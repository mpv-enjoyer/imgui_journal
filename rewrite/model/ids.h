...
{
    Wday m_wday;
    Pos<AMerged_Lesson> m_merged_lesson_pos;
public:
    Merged_Lesson_ID(Wday wday_, Pos<AMerged_Lesson> merged_lesson_pos_)
    : m_wday(wday_), m_merged_lesson_pos(merged_lesson_pos_) { }
    Wday wday() const { return m_wday; }
    Pos<AMerged_Lesson> pos() const { return m_merged_lesson_pos; }
...
class Internal_Lesson_ID
{
    ...
    Pos<AInternal_Lesson> m_internal_lesson_pos;
public:
    Internal_Lesson_ID(Merged_Lesson_ID merged_lesson_id, Pos<AInternal_Lesson> internal_lesson_pos)
    ...
    Pos<AMerged_Lesson> merged_lesson_pos() const { return m_merged_lesson_id.pos(); }
    Pos<AInternal_Lesson> pos() const { return m_internal_lesson_pos; }
...
class Internal_Student_ID
{
    ...
    Pos<AStudent> m_attendance_student_pos;
public:
    Internal_Student_ID(Internal_Lesson_ID internal_lesson_id, Pos<AStudent> attendance_student_pos)
    ...
    Pos<AMerged_Lesson> merged_lesson_pos() const { return m_internal_lesson_id.merged_lesson_pos(); }
    Pos<AInternal_Lesson> internal_lesson_pos() const { return m_internal_lesson_id.pos(); }
    Pos<AStudent> pos() const { return m_attendance_student_pos; }
...
public:
    ...
    Pos<AMerged_Lesson> merged_lesson_pos() const { return m_internal_student_id.merged_lesson_pos(); }
    Pos<AInternal_Lesson> internal_lesson_pos() const { return m_internal_student_id.internal_lesson_pos(); }
    Pos<AStudent> attendance_student_pos() const { return m_internal_student_id.pos(); }
