...
private:
    const size_t m_holders_count; // == aday count
...
public:
    ...
    : m_holders_count(holders_count), m_lesson_type(lesson_type), m_begin(begin), m_end(end), m_teachers_pos(holders_count)
    { }
    ...
    {
        m_attendance_students.push_back(Ptr<Attendance_Student>::make(m_holders_count, student_pos));
    }
