...
public:
    ...
    {
        Mday mday;
        Vector<Attendance_Merged_Lesson>::Position merged_lesson_pos;
        Vector<Attendance_Internal_Lesson>::Position internal_lesson_pos;
    ...
    Workout(Position real_pos, Position should_pos, Vector<Student>::Position student_pos)
...
private:
    ...
    Vector<Student>::Position m_student_pos;
};